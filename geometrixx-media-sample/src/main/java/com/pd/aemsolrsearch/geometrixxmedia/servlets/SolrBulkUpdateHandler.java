package com.pd.aemsolrsearch.geometrixxmedia.servlets;
...
import com.pd.aemsolrsearch.geometrixxmedia.model.GeometrixxMediaContentType;
import com.pd.aemsolrsearch.geometrixxmedia.model.GeometrixxMediaPage;
 ...
 */
@Component(
        name = "SolrBulkUpdateHandler",
        label = "AEM Solr Search Sample - Geometrixx Media Solr Update Handler",
...
@Properties({
    ...
    @Property(name = "sling.servlet.paths", value = "/apps/geometrixx-media/sample/updatehandler")
})
